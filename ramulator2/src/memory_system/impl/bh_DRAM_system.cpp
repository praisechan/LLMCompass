...
namespace Ramulator
{
  ...
  {
    RAMULATOR_REGISTER_IMPLEMENTATION(IMemorySystem, BHDRAMSystem, "BHDRAMSystem", "BHammer DRAM-based memory system.");
  ...
  public:
    void init() override
    {
      ...
      {
        IBHDRAMController *controller = create_child_ifce<IBHDRAMController>();
